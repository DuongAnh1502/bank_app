            ...
            <div className='sm:hidden flex flex-1 justify-end items-center'>
                ...
                >
                    <ul className='list-none flex flex-col justify-end items-start'>
                        {navLinks.map((nav, id) => (
                            <li
                                className={`font-poppins font-normal cursor-pointer text-[16px] text-gray-300 group ${
